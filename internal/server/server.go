...
func (h *Handler) handleAPI(w http.ResponseWriter, r *http.Request) bool {
	...
	if len(parts) == 4 && parts[0] == "api" && parts[1] == "w" && parts[3] == "execution-demand" && r.Method == http.MethodGet {
		h.handleCanonicalExecutionDemand(w, r, parts[2], "", "")
		return true
	}
	...
	if len(parts) == 6 && parts[0] == "api" && parts[1] == "w" && parts[3] == "clients" && parts[5] == "invocation-policy" && r.Method == http.MethodPut {
		h.handleCanonicalUpdateClientInvocationPolicy(w, r, parts[2], parts[4])
		return true
	}
	...
	if len(parts) == 6 && parts[0] == "api" && parts[1] == "w" && parts[3] == "apps" && parts[5] == "execution-demand" && r.Method == http.MethodGet {
		h.handleCanonicalExecutionDemand(w, r, parts[2], parts[4], "")
		return true
	}
	...
	if len(parts) == 8 && parts[0] == "api" && parts[1] == "w" && parts[3] == "apps" && parts[5] == "actions" && parts[7] == "execution-demand" && r.Method == http.MethodGet {
		h.handleCanonicalExecutionDemand(w, r, parts[2], parts[4], parts[6])
		return true
	}
