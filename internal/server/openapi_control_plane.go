...
func buildControlPlaneOpenAPI(baseURL string, workspaceID string) map[string]any {
	...
	addOpaqueHTTPProjectionControlPlanePaths(paths, workspaceID)
	...
	addOpaqueHTTPProjectionControlPlaneSchemas(schemas)
	...
	return map[string]any{
		...
		"WorkerGroupObservation": map[string]any{
			...
			"properties": map[string]any{
				...
				"pressure_accepting_workers":   map[string]any{"type": "integer", "minimum": 0},
				"pressure_paused_workers":      map[string]any{"type": "integer", "minimum": 0},
				"stale_pressure_workers":       map[string]any{"type": "integer", "minimum": 0},
				"pressure_reason_codes":        map[string]any{"type": "array", "items": oapiStringEnumSchema("memory_high", "cpu_high", "file_descriptors_high", "observation_unknown")},
			...
			"required": []any{
				"group", "run_state", "run_state_revision", "observed_at", "live_workers", "pressure_accepting_workers", "pressure_paused_workers",
				"stale_pressure_workers", "pressure_reason_codes", "unmanaged_live_workers", "available_slots",
		...
		"WorkerGroupInventoryItem": map[string]any{
			...
			"required": []any{
				...
				"live_workers", "pressure_accepting_workers", "pressure_paused_workers", "stale_pressure_workers", "pressure_reason_codes",
				"unmanaged_live_workers", "total_slots", "occupied_slots", "available_slots", "active_leases", "running_jobs", "quiescent",
		...
		"WorkerGroupPlacementCandidate": map[string]any{
			...
			"properties": map[string]any{
				...
				"reason_codes":           map[string]any{"type": "array", "items": oapiStringEnumSchema("workspace_not_allowed", "draining", "no_live_capacity", "missing_tag", "missing_label", "execution_profile_mismatch", "resource_pressure")},
				"version_or_build_drift": oapiBooleanSchema(),
			},
