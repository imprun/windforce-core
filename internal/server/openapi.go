...
func oapiStatusSchema() map[string]any {
	return map[string]any{
		...
		"description": "Terminal job result status. A failed action surfaces as \"failure\" within a 200 response, not an HTTP error — inspect result for the failure detail.",
	}
}
