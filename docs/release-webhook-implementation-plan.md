...
- 로컬 개발은 `WINDFORCE_CORE_WEBHOOK_ALLOW_INSECURE_LOOPBACK=true`로만 HTTP loopback을 허용한다.
...
```text
WINDFORCE_CORE_WEBHOOK_DISPATCH_INTERVAL
WINDFORCE_CORE_WEBHOOK_REQUEST_TIMEOUT
WINDFORCE_CORE_WEBHOOK_MAX_ATTEMPTS
WINDFORCE_CORE_WEBHOOK_LEASE_TTL
WINDFORCE_CORE_WEBHOOK_ALLOWED_HOSTS
WINDFORCE_CORE_WEBHOOK_ALLOWED_CIDRS
WINDFORCE_CORE_WEBHOOK_ALLOW_INSECURE_LOOPBACK
WINDFORCE_CORE_WEBHOOK_SUCCESS_RETENTION_DAYS
WINDFORCE_CORE_WEBHOOK_FAILURE_RETENTION_DAYS
WINDFORCE_CORE_WEBHOOK_RETENTION_INTERVAL
WINDFORCE_CORE_WEBHOOK_RETENTION_BATCH_SIZE
WINDFORCE_CORE_WEBHOOK_RETENTION_TIME_BUDGET
```
