export default {
  ...
  title: "Inspect a deployment request detail",
  description: "Open a deployment request detail page to review the pinned commit, timeline, requester message, operator decision state, and related FCode.",
