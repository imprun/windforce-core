export default {
  ...
  title: "Review WorkerGroups on a narrow screen",
  description:
  ...
  guide: [
    "Open Worker groups from the mobile navigation.",
    "Review queued Runs and slot usage first, then scroll pinned demand and group inventory horizontally when needed.",
  ],
