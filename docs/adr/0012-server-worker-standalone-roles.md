...
Superseded in part (2026-07-27) by [ADR 0013](0013-canonical-invocation-and-trigger-boundary.md). 외부 adapter용 Execution API와 네 HTTP plane 유지 결정은 canonical Invocation API와 세 HTTP boundary로 대체되었다. Original decision: Accepted (2026-07-22) — issue #126.
