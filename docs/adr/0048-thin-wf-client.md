# ADR 0048: Ship `wf` as a thin workspace client

## Status

Superseded by [ADR 0018](0018-client-release-boundary.md) (2026-07-29).

Numbering note (2026-08-18): this decision was originally published as ADR 0015 and was renumbered to ADR 0048 to resolve a historical collision with the earlier HTTP Route Binding decision. The status, date, and decision meaning are unchanged.
